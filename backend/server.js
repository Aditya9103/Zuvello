...
app.use(cors({
    origin: [
        'http://localhost:5173',
        'https://zuvello.vercel.app',
        'https://www.zuvello.in',
        'https://zuvello.in',
...
app.get("/", (req, res) => res.status(200).json({ success: true, message: "zuvello  server running..." }));
...
console.log('✅ Routes mounted: /api/auth, /api/products, /api/blogs, /api/orders, /api/upload, /api/admin, /api/enquiry, /api/coupons, /api/instagram, /api/reviews, /api/payment');
